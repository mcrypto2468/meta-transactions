...
import "@openzeppelin/contracts/utils/cryptography/MessageHashUtils.sol"; // Import MessageHashUtils.sol
...
contract TokenSender {
    ...
    function transfer(
        ...
        // Convert it to a signed message hash using MessageHashUtils
